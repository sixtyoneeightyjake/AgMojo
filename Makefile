...
lint-backend: check-python check-poetry install-python-dependencies
	@echo "$(YELLOW)Running linters...$(RESET)"
	@poetry run ruff check --config dev_config/python/ruff.toml openhands/ evaluation/ tests/ --fix
	@poetry run ruff format --config dev_config/python/ruff.toml openhands/ evaluation/ tests/
