...
import { useSyncGitHubToken } from "#/hooks/use-sync-github-token";
...
export default function MainApp() {
  ...
  // Supabase auth gating (if configured)
  ...
  }, [supaLoading, hasSession, pathname]);
  ...
  return (
    ...
    >
      {/* If Supabase is configured and we're waiting on auth, show nothing */}
      ...
      {/* analytics consent modal removed */}
