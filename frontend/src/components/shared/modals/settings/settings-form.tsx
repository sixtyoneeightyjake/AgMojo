      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <HelpLink
            ...
            text={t("SETTINGS$DONT_KNOW_API_KEY", {
              defaultValue: "Don't know your API key?",
            })}
            linkText={t("SETTINGS$CLICK_FOR_INSTRUCTIONS", {
              defaultValue: "Click here for instructions",
            })}
