    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span>
            {t("PAYMENT$MANAGE_CREDITS", { defaultValue: "Manage credits" })}
          </span>
        </div>
        {!isLoading && (
      ...
      <div className="flex flex-col gap-3">
        <SettingsInput
          ...
          type="number"
          label={t("PAYMENT$ADD_FUNDS", { defaultValue: "Add funds" })}
          placeholder={t("PAYMENT$SPECIFY_AMOUNT_USD", {
            defaultValue: "Specify amount (USD)",
          })}
          className="w-[680px]"
          min={10}
          max={25000}
        ...
        <div className="flex items-center w-[680px] gap-2">
          ...
          >
            {t("PAYMENT$ADD_CREDIT", { defaultValue: "Add credit" })}
          </BrandButton>
