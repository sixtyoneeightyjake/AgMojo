...
export function MCPServerListItem({
  ...
  return (
    ...
    >
      <td
        className="p-3 text-sm text-content-secondary truncate min-w-0"
        title={serverName}
      >
        {serverName}
      </td>

      <td className="p-3 text-sm text-content-secondary whitespace-nowrap">
        {getServerTypeLabel(server.type)}
      </td>

      <td
        className="p-3 text-sm text-content-secondary opacity-80 italic min-w-0 truncate"
