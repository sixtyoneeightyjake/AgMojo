...
export function SecretListItem({
  ...
  return (
    ...
    >
      <td
        className="p-3 w-1/4 text-sm text-content-secondary truncate"
        title={title}
      >
        {title}
      </td>
      ...
      <td
        className="p-3 w-1/2 truncate overflow-hidden whitespace-nowrap text-sm text-content-secondary opacity-80 italic"
        title={description || ""}
      >
        {description || ""}
      </td>
