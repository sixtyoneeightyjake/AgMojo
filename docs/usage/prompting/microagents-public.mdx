...
description: Global microagents are [keyword-triggered microagents](./microagents-keyword) that apply to all Agent Mojo users. A list of the current global microagents can be found [in the Agent Mojo repository](https://github.com/All-Hands-AI/Agent Mojo/tree/main/microagents).
---
...
See the [CONTRIBUTING.md](https://github.com/All-Hands-AI/Agent Mojo/blob/main/CONTRIBUTING.md) for specific instructions on how to contribute to Agent Mojo.
...
[`microagents/`](https://github.com/All-Hands-AI/Agent Mojo/tree/main/microagents)
